...
class Ui_dingdan(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(270, 390, 110, 28))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setText(_translate("Dialog", "已出库记录", None))
        self.pushButton_2.setText(_translate("Dialog", "全部记录", None))
        self.pushButton_3.setText(_translate("Dialog", "库中货物", None))
        self.pushButton_4.setText(_translate("Dialog", "正在处理货物", None))
